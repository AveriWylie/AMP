...
Requires Python 3.9+.
blocks.json — download for your target version from PrismarineJS/minecraft-data at data/pc/<version>/blocks.json. Place it in a blocks/ folder in the project root named blocks_<version>.json, for example blocks_1.20.1.json.
